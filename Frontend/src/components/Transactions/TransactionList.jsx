...
import { getCategoryApi } from "../../services/category/categoryService";
...
const TransactionList = () => {
 ...
 const handleFilterChange = (e) => {
  ...
  const hasActiveFilter = Object.values(updatedFilters).some(v => v !== "");
  if (hasActiveFilter) {
    mutateAsync(updatedFilters);
  } else {
    reset(); // from useMutation: add `reset` to destructured values
  }
};
  return (
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div className="relative">
          ...
          >
            ...
            {categories?.data?.body?.categories.map((category) => (
